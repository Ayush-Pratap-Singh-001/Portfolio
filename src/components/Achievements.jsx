...
const PLATFORMS = [
    {
        ...
        bgColor: '#f59e0b12',
        icon: '🟡',
        rank: '150+ problem solved',
        stats: [
            { label: 'Problems Solved', value: '150+', icon: <Code size={16} /> },
    ...
    },
    {
        ...
        rank: '4 Star — Silver',
        stats: [
            { label: 'Stars Earned', value: '4 ⭐', icon: <Star size={16} /> },
            { label: 'Badges', value: '4', icon: <Trophy size={16} /> },
            { label: 'Rank', value: 'Silver', icon: <Target size={16} /> },
            { label: 'Certificates', value: '1', icon: <Users size={16} /> },
        ],
        highlights: [
            '3-Star Silver badge in Problem Solving',
            'Silver-level Java domain badges',
            'Earned 1 HackerRank skill certifications',
        ],
        tags: ['Problem Solving', 'Java', 'Python', 'C++'],
    },
    {
        id: 'codechef',
        name: 'CodeChef',
        handle: 'jarvis_001',
        link: 'https://www.codechef.com/users/jarvis_001',
        color: '#b45309',
        bgColor: '#b4530912',
        icon: '🍴',
        rank: '4★ Coder',
        stats: [
            { label: 'Rating', value: '1162', icon: <TrendingUp size={16} /> },
            { label: 'Stars', value: '1 ★', icon: <Star size={16} /> },
            { label: 'Global Rank', value: '97460', icon: <Target size={16} /> },
            { label: 'Contests', value: '5+', icon: <Trophy size={16} /> },
        ],
        highlights: [
            '1-Star coder with peak rating of 1,162',
            'Participated in 5+ Division 4 contests',
            // 'Solved 100+ problems on the platform',
...
/* ── Summary bar ────────────────────────────────────────────────────── */
const SUMMARY_STATS = [
    { label: 'Total Problems', value: '250+', color: '#3b82f6', icon: <Code size={20} /> },
    { label: 'Platform Rating', value: '4 Active', color: '#10b981', icon: <Users size={20} /> },
    { label: 'Contest Rounds', value: '35+', color: '#f59e0b', icon: <Trophy size={20} /> },
